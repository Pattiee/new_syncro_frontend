...
export const ContactsNavbar = () => {
  return (
    <div className="w-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-xs">
      <div className="w-full mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <span className="text-gray-700 dark:text-gray-200">+254727608698</span>
          <span className="text-gray-700 dark:text-gray-200">info@syncro.co.ke</span>
        </div>
