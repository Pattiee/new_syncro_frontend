...
const Cart = () => {
    ...
    const handleNavigateCheckout = () => keycloak.authenticated ? navigate(MAIN_LINKS_FRONTEND.CHECKOUT) : keycloak.login();

    const handleNavigateHome = () => navigate('/');

    return (
        <div className='flex h-screen'>
            <div className='flex flex-col p-2 m-auto bg-white shadow-xl dark:bg-gray-800 rounded-2xl sm:px-8 sm:py-10'>
                ...
                <div className='flex rounded-3xl justify-between mt-3'>
                    ...
                    <p
                        ...
                        className='px-4 mx-4 font-mono py-2 text-red-500 transition border-none rounded-full dark:text-red-400 disabled:text-red-300 hover:bg-red-100 dark:hover:bg-orange-900 disabled:opacity-50 disabled:cursor-not-allowed hover:disabled:bg-transparent dark:hover:disabled:bg-transparent'
                    >
                        Clear cart
                    </p>
                    ...
                    <p
                        ...
                        className='flex px-4 mx-4 py-2 text-orange-600 transition border-none border-orange-500 rounded-full float-end font-mono dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-900'
                    >
                        Continue Shopping
                    </p>
                </div>
